        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                var products = new[]
                {
                    ...
                    new Product(){ ProductName="Samsung Earphone",Stock=70, Price=125, Image="earphone3.jpg",IsHome=true,IsApproved=true,IsFeatured=true, Description="Earphone is used for listening music on phones or another electronic devices.", HtmlContent="Earphone is used for listening music on phones or another electronic devices.", DateAdded=DateTime.Now.AddDays(-5)},
                    ...
                    new Product(){ ProductName="Asus Monitor",Stock=90, Price=2500, Image="monitor8.jpg",IsHome=true,IsApproved=true,IsFeatured=true, Description="A monitor is an electronic visual computer display that includes a screen, circuitry and the case in which that circuitry is enclosed.", HtmlContent="A monitor is an electronic visual computer display that includes a screen, circuitry and the case in which that circuitry is enclosed.", DateAdded=DateTime.Now.AddDays(-2)},
                    new Product(){ ProductName="Acer Monitor",Stock=90, Price=4500, Image="monitor5.jpg",IsHome=true,IsApproved=true,IsFeatured=true, Description="A monitor is an electronic visual computer display that includes a screen, circuitry and the case in which that circuitry is enclosed.", HtmlContent="A monitor is an electronic visual computer display that includes a screen, circuitry and the case in which that circuitry is enclosed.", DateAdded=DateTime.Now.AddDays(-2)},
                    ...
                    new Product(){ ProductName="MSI Monitor",Stock=90, Price=6500, Image="monitor6.jpg",IsHome=true,IsApproved=true,IsFeatured=true, Description="A monitor is an electronic visual computer display that includes a screen, circuitry and the case in which that circuitry is enclosed.", HtmlContent="A monitor is an electronic visual computer display that includes a screen, circuitry and the case in which that circuitry is enclosed.", DateAdded=DateTime.Now.AddDays(-2)},
                ...
                var images = new[]
                {
                    ...
                    new Image(){ ImageName="photo11.jpg", Product=products[0]},
                    ...
                    new Image(){ ImageName="photo11.jpg", Product=products[1]},
                    ...
                    new Image(){ ImageName="photo11.jpg", Product=products[2]},
